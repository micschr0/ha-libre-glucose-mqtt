...
- [Configure](configuration.md) units, regions, MQTT topics, and advanced options.
- [Troubleshoot](troubleshooting.md) common problems and understand the add-on's architecture.
- Try the [Clock View](clock-view.md) — a real-time full-screen display accessible from the HA sidebar.
