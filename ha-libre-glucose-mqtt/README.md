...
& Services → MQTT** within minutes of starting the add-on.

Powered by [`gluco-hub-rs`](https://github.com/micschr0/gluco-hub-rs).
This add-on is a thin Bash + Docker wrapper around the upstream Rust
...
- The official **Mosquitto broker** add-on installed and the **MQTT**
  Home Assistant integration configured. The add-on refuses to start
