...
<reference>
@/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/user-profiling.md` to load:
