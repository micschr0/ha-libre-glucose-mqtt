...
<required_reading>
Read `/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
