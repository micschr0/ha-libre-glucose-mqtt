...
@/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/thinking-models-research.md
...
```bash
node "/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
