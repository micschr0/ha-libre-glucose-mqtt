...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/claude/projects/ha-libre-glucose-mqtt/.claude/.gsd-surface.json`
(sibling to `/home/claude/projects/ha-libre-glucose-mqtt/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/claude/projects/ha-libre-glucose-mqtt/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/claude/projects/ha-libre-glucose-mqtt/.claude/skills`).
...
`/home/claude/projects/ha-libre-glucose-mqtt/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/claude/projects/ha-libre-glucose-mqtt/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/claude/projects/ha-libre-glucose-mqtt/.claude/.gsd-surface.json`
Install profile marker: `/home/claude/projects/ha-libre-glucose-mqtt/.claude/.gsd-profile`
Skill dirs: `/home/claude/projects/ha-libre-glucose-mqtt/.claude/skills/gsd-*/`
Engine module: `/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
