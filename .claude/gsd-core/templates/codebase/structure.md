...
- Usage: Reference from command with `@/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/claude/projects/ha-libre-glucose-mqtt/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/claude/projects/ha-libre-glucose-mqtt/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
