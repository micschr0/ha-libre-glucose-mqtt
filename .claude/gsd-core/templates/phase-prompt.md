...
<!-- For checkpoint task examples and patterns, see @/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
