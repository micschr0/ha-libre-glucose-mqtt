...
```bash
INIT=$(node "/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/bin/gsd-tools.cjs" commit \
