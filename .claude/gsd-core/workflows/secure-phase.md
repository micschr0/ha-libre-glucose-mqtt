...
```
Agent(
  prompt="Read /home/claude/projects/ha-libre-glucose-mqtt/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/templates/SECURITY.md`
