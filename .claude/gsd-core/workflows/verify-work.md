...
<template>
@/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/workflows/diagnose-issues.md
