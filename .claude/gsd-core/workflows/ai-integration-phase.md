...
<required_reading>
@/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/ai-frameworks.md
@/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/claude/projects/ha-libre-glucose-mqtt/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/claude/projects/ha-libre-glucose-mqtt/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/claude/projects/ha-libre-glucose-mqtt/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/claude/projects/ha-libre-glucose-mqtt/.claude/agents/gsd-eval-planner.md for instructions.
