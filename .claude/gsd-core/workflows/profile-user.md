...
Key references:
- @/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/home/claude/projects/ha-libre-glucose-mqtt/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/USER-PROFILE.md" "/home/claude/projects/ha-libre-glucose-mqtt/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /home/claude/projects/ha-libre-glucose-mqtt/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/claude/projects/ha-libre-glucose-mqtt/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/claude/projects/ha-libre-glucose-mqtt/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/home/claude/projects/ha-libre-glucose-mqtt/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/claude/projects/ha-libre-glucose-mqtt/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /home/claude/projects/ha-libre-glucose-mqtt/.claude/CLAUDE.md
```
