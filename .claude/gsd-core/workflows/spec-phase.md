...
```bash
INIT=$(node "/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/templates/spec.md.
