...
INSTALL_JS_GLOBAL="/home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/claude/projects/ha-libre-glucose-mqtt/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
