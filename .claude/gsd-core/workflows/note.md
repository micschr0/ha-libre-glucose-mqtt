...
- **Global scope**: `/home/claude/projects/ha-libre-glucose-mqtt/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/claude/projects/ha-libre-glucose-mqtt/.claude/notes/`)
...
2. Glob `/home/claude/projects/ha-libre-glucose-mqtt/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/claude/projects/ha-libre-glucose-mqtt/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/claude/projects/ha-libre-glucose-mqtt/.claude/notes/` — works in any directory
